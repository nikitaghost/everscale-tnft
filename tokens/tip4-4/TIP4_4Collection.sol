...
contract TIP4_4Collection is TIP4_1Collection, ITIP4_4Collection {
    ...
    uint128 _deployStorageValue = 0.5 ton;         
    ...
    function mintNft(
        ...
        require(msg.value > _remainOnNft + _deployStorageValue + 0.1 ton, CollectionErrors.value_is_less_than_required);
        tvm.rawReserve(msg.value, 1);

        address newStorage = _deployStorage(uploader, mimeType, chunksNum);
